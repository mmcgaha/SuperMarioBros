...
{
    public class PeopleTextures : ITechnicalCommand
    {
        public PeopleTextures()
        {
        }
        ...
        public void Execute()
        {
            var list = new List<Texture2D>()
            {
                ...
                Textures.blockAxe,
                Textures.blockBillBlasterTall,
                Textures.blockBillBlasterMed,
                Textures.blockBillBlasterShort,
            ...
            Textures.powerup1up = list[random.Next(0, list.Count())];
                ...
                Textures.blockBillBlasterTall = list[random.Next(0, list.Count())];
                Textures.blockBillBlasterMed = list[random.Next(0, list.Count())];
                Textures.blockBillBlasterShort = list[random.Next(0, list.Count())];
