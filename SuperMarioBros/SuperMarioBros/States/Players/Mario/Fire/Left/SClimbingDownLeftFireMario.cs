...
{
    public class SClimbingDownLeftFireMario : IFireMarioState, IClimbingMarioState, ILeftMarioState
    {
        public IPlayer Player { get; set; }

        public SClimbingDownLeftFireMario(IPlayer player)
        {
            this.Player = player;
            Player.Sprite = new MarioAnimation(HUD.currentPlayer == 0 ? Textures.mario0 : Textures.luigi0, Textures.fireLeftClimbing);
