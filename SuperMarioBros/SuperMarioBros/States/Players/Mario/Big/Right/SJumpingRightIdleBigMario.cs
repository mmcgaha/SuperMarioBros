...
{
    public class SJumpingRightIdleBigMario : IBigMarioState, IJumpingMarioState, IRightMarioState
    {
        public IPlayer Player { get; set; }

        public SJumpingRightIdleBigMario(IPlayer player)
        {
            this.Player = player;
        ...
        public void PowerUp()
        {
            Player.State = new SMarioTansition(Player, typeof(SJumpingRightIdleFireMario), Textures.fireJumpingIdleTransitionRight);
        }
