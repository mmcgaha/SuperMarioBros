...
{
    public class SIdleRightBigMario : IBigMarioState, IIdleMarioState, IRightMarioState
    {
        public IPlayer Player { get; set; }

        public SIdleRightBigMario(IPlayer player)
        {
            this.Player = player;
        ...
        public void PowerUp()
        {
            Player.State = new SMarioTansition(Player, typeof(SIdleRightFireMario), Textures.fireIdleTransitionRight); 
        }
