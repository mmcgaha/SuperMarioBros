...
{
    public class SDuckingLeftBigMario : IBigMarioState, IDuckingMarioState, ILeftMarioState
    {
        public IPlayer Player { get; set; }

        public SDuckingLeftBigMario(IPlayer player)
        {
            this.Player = player;
            Player.Sprite = new MarioAnimation(HUD.currentPlayer == 0 ? Textures.mario0 : Textures.luigi0, Textures.bigLeftDucking);
        ...
        public void Jump()
        {
            Player.State = new SJumpingLeftIdleBigMario(Player);
        }
        ...
        public void PowerUp()
        {
            Player.State = new SMarioTansition(Player, typeof(SDuckingLeftFireMario), Textures.fireDuckingTransitionLeft);
        }
