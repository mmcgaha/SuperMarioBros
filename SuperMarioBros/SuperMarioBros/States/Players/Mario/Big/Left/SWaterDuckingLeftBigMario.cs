...
{
    public class SWaterDuckingLeftBigMario : IBigMarioState, IDuckingMarioState, ILeftMarioState
    {
        public IPlayer Player { get; set; }

        public SWaterDuckingLeftBigMario(IPlayer player)
        {
            this.Player = player;
        ...
        public void PowerUp()
        {
            Player.State = new SMarioTansition(Player, typeof(SWaterDuckingLeftFireMario), Textures.fireDuckingTransitionLeft);
        }
