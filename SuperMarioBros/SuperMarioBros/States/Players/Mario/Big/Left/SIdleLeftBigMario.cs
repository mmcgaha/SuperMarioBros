...
{
    public class SIdleLeftBigMario : IBigMarioState, IIdleMarioState, ILeftMarioState
    {
        public IPlayer Player { get; set; }

        public SIdleLeftBigMario(IPlayer player)
        {
            this.Player = player;
        ...
        public void PowerUp()
        {
            Player.State = new SMarioTansition(Player, typeof(SIdleLeftFireMario), Textures.fireIdleTransitionLeft);
        }
