...
{
    public class SJumpingLeftBigMario : IBigMarioState, IJumpingMarioState, ILeftMarioState
    {
        public IPlayer Player { get; set; }

        public SJumpingLeftBigMario(IPlayer player)
        {
            this.Player = player;
        ...
        public void PowerUp()
        {
            Player.State = new SMarioTansition(Player, typeof(SJumpingLeftFireMario), Textures.fireJumpingTransitionLeft);
        }
