...
{
    public class SClimbingIdleLeftBigMario : IBigMarioState, IClimbingMarioState, ILeftMarioState
    {
        public IPlayer Player { get; set; }
        private int timer;

        public SClimbingIdleLeftBigMario(IPlayer player)
        {
            this.Player = player;
            this.timer = 0;
            Player.Sprite = new MarioAnimation(HUD.currentPlayer == 0 ? Textures.mario0 : Textures.luigi0, Textures.bigLeftClimbingIdle);
        ...
        public void GoDown()
        {
            Player.State = new SClimbingDownLeftBigMario(Player);
        }
