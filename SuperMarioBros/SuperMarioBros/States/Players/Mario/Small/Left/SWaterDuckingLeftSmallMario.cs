...
{
    public class SWaterDuckingLeftSmallMario : ISmallMarioState, IDuckingMarioState, ILeftMarioState
    {
        public IPlayer Player { get; set; }

        public SWaterDuckingLeftSmallMario(IPlayer player)
        {
            this.Player = player;
        ...
        public void PowerUp()
        {
            Player.State = new SMarioTansition(Player, typeof(SWaterIdleLeftBigMario), Textures.smallBigTransitionLeft); 
        }
