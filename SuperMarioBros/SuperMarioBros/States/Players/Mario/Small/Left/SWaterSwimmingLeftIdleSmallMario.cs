...
{
    public class SWaterSwimmingLeftIdleSmallMario : ISmallMarioState, IJumpingMarioState, ILeftMarioState
    {
        public IPlayer Player { get; set; }

        public SWaterSwimmingLeftIdleSmallMario(IPlayer player)
        {
            this.Player = player;
        ...
        public void PowerUp()
        {
            Player.State = new SMarioTansition(Player, typeof(SWaterSwimmingLeftIdleBigMario), Textures.smallBigTransitionLeft);
        }
