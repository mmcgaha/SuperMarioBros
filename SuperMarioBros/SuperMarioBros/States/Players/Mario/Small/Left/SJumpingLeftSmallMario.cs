...
{
    public class SJumpingLeftSmallMario : ISmallMarioState, IJumpingMarioState, ILeftMarioState
    {
        ...
        public void PowerUp()
        {
            Player.State = new SMarioTansition(Player, typeof(SJumpingLeftBigMario), Textures.smallBigTransitionLeft); 
        }
