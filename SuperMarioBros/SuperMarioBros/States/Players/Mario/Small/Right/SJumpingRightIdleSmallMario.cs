...
{
    public class SJumpingRightIdleSmallMario : ISmallMarioState, IJumpingMarioState, IRightMarioState
    {
        public IPlayer Player { get; set; }

        public SJumpingRightIdleSmallMario(IPlayer player)
        {
            this.Player = player;
        ...
        public void PowerUp()
        {
            Player.State = new SMarioTansition(Player, typeof(SJumpingRightIdleBigMario), Textures.smallBigTransitionRight);
        }
