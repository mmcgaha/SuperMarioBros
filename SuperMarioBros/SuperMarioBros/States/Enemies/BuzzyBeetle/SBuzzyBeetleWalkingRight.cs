...
{
    public class SBuzzyBeetleWalkingRight : IEnemyState
    {
        public IEnemy Enemy { get; set; }

        public SBuzzyBeetleWalkingRight(IEnemy enemy)
        {
            this.Enemy = enemy;
            Enemy.Sprite = new Animation(Textures.buzzyBeetleRightWalking, 2, 8);
