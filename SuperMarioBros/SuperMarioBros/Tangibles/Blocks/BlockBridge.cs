...
{
    public class BlockBridge : IBlock
    {
        ...
        public BlockBridge(int x = 0, int y = 0)
        {
            this.Position = new Vector2(x, y);
            this.Velocity = Vector2.Zero;
            this.Hitbox = new Hitbox(Hitboxes.BRIDGE_OFFSET_X, Hitboxes.BRIDGE_OFFSET_Y);
            this.State = new SBlockIdle(this);
            this.Sprite = new Animation(Textures.blockBridge);
            this.IsActive = true;
