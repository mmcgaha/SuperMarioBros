...
{
    public class FallingPlatform : IBlock
    {
        ...
        public FallingPlatform(int width, int x = 0, int y = 0)
        {
            ...
            this.IsActive = true;
            this.CollisionHandler = new FallingPlatformCollisionHandler(this, width);
            this.width = width;
        }
        ...
        public void Update()
        {
            ...
            State.Update();
            Sprite.Update();
            State = new SPlatformIdle(this, width);
        }
