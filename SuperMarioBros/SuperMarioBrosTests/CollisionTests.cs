...
namespace SuperMarioBrosTests
{
    public class CollisionTests
    {
        public class PhysicsBundle
        {
            ...
            {
                SuperMarioBros.Textures.LoadTextureMaps();
        ...
        public Boolean TestCollision(ITangible tangible1, ITangible tangible2, SuperMarioBros.Collider.CollisionFrom expected)
        {
            tangible1.Update();
            tangible2.Update();

            SuperMarioBros.Collider.CollisionFrom returned = collider.CollisionDirection(tangible1, tangible2);
